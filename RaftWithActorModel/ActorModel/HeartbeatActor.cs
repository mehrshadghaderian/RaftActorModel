    ...
    public class HeartbeatActor:ReceiveActor
    {
        ...
        public HeartbeatActor()
        {
            ...
            Receive<Heartbeat>(hb =>
            {
                ...
                {
                    Console.Write(".");
                    RaftEvents.OnHeartbeat?.Invoke(Sender.Path.ToString(),hb);
                }
            });
            ...
            Receive<HeartbeatResponse>(hbr =>
            {
                if (Sender != Self)
                {
                    RaftEvents.OnHeartbeatResponse?.Invoke(hbr);
                }
            });
            ...
            Receive<MemberStatusChange>(_ =>
            {
                ...
                {
                    _joinedCluster = true;
                    RaftEvents.OnJoinedCluster?.Invoke();
                }
                ...
                if(_membersCount!=membersCount)
                {
                    ...
                    RaftEvents.OnMemberChanged?.Invoke(_membersCount);
                }
            });
